...
class FutureValueFrame(ttk.Frame):
    ...
    def initComponents(self):
        ...
        # Display the labels, text entry fields, and combo boxes
        ...
        self.yearsCombo = ttk.Combobox(
            self, width=22, values=list(range(1, 11)), state="readonly")
        self.yearsCombo.grid(column=1, row=2)
        ...
        # Select default years option
        self.yearsCombo.current(4)
    ...
    # helper method to convert user entry to float
    ...
    def calculate(self):
        ...
        self.investment.years = int(self.yearsCombo.get())
